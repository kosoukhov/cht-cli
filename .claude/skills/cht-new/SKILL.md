---
name: cht-new
description: "Create a new chat conversation and start recording messages. Use when the user wants to start a new conversation, begin a chat, or create a fresh session."
...
1. Run: `cht create $ARGUMENTS`
   - If no arguments provided, use: `cht create general "(untitled)"`
2. Parse the JSON output.
3. On success (`ok: true`):
   - Run: `cht session-set <chat_path> <project>` to activate session tracking
