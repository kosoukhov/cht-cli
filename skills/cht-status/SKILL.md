---
name: cht-status
description: "Show size and status of the active chat. Use when the user asks how big the current chat is, how many messages there are, or wants chat statistics."
