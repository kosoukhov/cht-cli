---
name: cht-continue
description: "Resume a previous chat conversation with full history loaded. Use when the user wants to continue, pick up, or go back to an earlier conversation."
allowed-tools:
  - Read
  - Bash(cht *)
...
6. Once the user selects a chat:
   ...
   - Run: `cht session-set <selected_chat_path> <project>` to activate session tracking. This ensures hooks start saving new messages to this chat file.
