...
6. First check if this chat is the active session: run `cht session-get` and compare the path.
7. Run: `cht archive <selected_chat_path> <project>` (project from args, default "general")
