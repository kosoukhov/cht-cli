...
1. Run: `cht list $ARGUMENTS --archived` (uses --archived flag to list only archived chats)
...
6. Run: `cht restore <selected_chat_path> <project>` (project from args, default "general")
